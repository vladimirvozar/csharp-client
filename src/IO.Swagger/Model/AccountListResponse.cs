...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AccountListResponse :  IEquatable<AccountListResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public AccountListResponse(ExternalResponseHeaderV3 groupHeader = default(ExternalResponseHeaderV3), AccountList response = default(AccountList))
        {
        ...
        {
            return this.Equals(input as AccountListResponse);
        }

        /// <summary>
        /// Returns true if AccountListResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountListResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountListResponse input)
        {
            if (input == null)
                return false;
