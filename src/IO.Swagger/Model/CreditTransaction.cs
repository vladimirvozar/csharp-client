...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreditTransaction : Transaction,  IEquatable<CreditTransaction>, IValidatableObject
    {
        /// <summary>
        ...
        public CreditTransaction(decimal? amount = default(decimal?), decimal? balanceAfterTransaction = default(decimal?), DateTime? bookingDate = default(DateTime?), string cardNumber = default(string), string counterpartyName = default(string), CurrencyEnum currency = default(CurrencyEnum), decimal? currencyRate = default(decimal?), string message = default(string), string narrative = default(string), OriginalCurrencyEnum? originalCurrency = default(OriginalCurrencyEnum?), decimal? originalCurrencyAmount = default(decimal?), string ownMessage = default(string), DateTime? paymentDate = default(DateTime?), string reference = default(string), StatusEnum status = default(StatusEnum), DateTime? transactionDate = default(DateTime?), string transactionId = default(string), string typeDescription = default(string), DateTime? valueDate = default(DateTime?)) : base()
        {
            ...
            if (bookingDate == null)
            {
                throw new InvalidDataException("bookingDate is a required property for CreditTransaction and cannot be null");
            }
            else
            {
            ...
            if (currency == null)
            {
                throw new InvalidDataException("currency is a required property for CreditTransaction and cannot be null");
            }
            else
            {
            ...
            if (status == null)
            {
                throw new InvalidDataException("status is a required property for CreditTransaction and cannot be null");
            }
            else
            {
                this.Status = status;
            ...
            {
                throw new InvalidDataException("transactionId is a required property for CreditTransaction and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as CreditTransaction);
        }

        /// <summary>
        /// Returns true if CreditTransaction instances are equal
        /// </summary>
        /// <param name="input">Instance of CreditTransaction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreditTransaction input)
        {
            if (input == null)
                return false;
