...
namespace IO.Swagger.Model
{
    ...
    public partial class AccountDetails :  IEquatable<AccountDetails>, IValidatableObject
    {
        ...
        public AccountDetails(string id = default(string), List<Link> links = default(List<Link>), string accountName = default(string), List<AccountNumber> accountNumbers = default(List<AccountNumber>), AccountTypeEnum accountType = default(AccountTypeEnum), decimal? availableBalance = default(decimal?), BankInfo bank = default(BankInfo), decimal? bookedBalance = default(decimal?), CountryEnum? country = default(CountryEnum?), decimal? creditLimit = default(decimal?), CurrencyEnum currency = default(CurrencyEnum), DateTime? latestTransactionBookingDate = default(DateTime?), string product = default(string), StatusEnum status = default(StatusEnum), decimal? valueDatedBalance = default(decimal?))
        {
            ...
            if (accountName == null)
            {
                throw new InvalidDataException("accountName is a required property for AccountDetails and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("accountNumbers is a required property for AccountDetails and cannot be null");
            }
            else
            {
            ...
            if (accountType == null)
            {
                throw new InvalidDataException("accountType is a required property for AccountDetails and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("availableBalance is a required property for AccountDetails and cannot be null");
            }
            else
            {
            ...
            if (bank == null)
            {
                throw new InvalidDataException("bank is a required property for AccountDetails and cannot be null");
            }
            else
            {
                this.Bank = bank;
            ...
            {
                throw new InvalidDataException("bookedBalance is a required property for AccountDetails and cannot be null");
            }
            else
            {
            ...
            if (currency == null)
            {
                throw new InvalidDataException("currency is a required property for AccountDetails and cannot be null");
            }
            else
            {
            ...
            if (product == null)
            {
                throw new InvalidDataException("product is a required property for AccountDetails and cannot be null");
            }
            else
            {
            ...
            if (status == null)
            {
                throw new InvalidDataException("status is a required property for AccountDetails and cannot be null");
            }
            else
            {
                this.Status = status;
